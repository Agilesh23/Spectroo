...
- **`SpectrooMainWindow`**
  The central controller class. It initializes components, configures thread workers (`LivePipelineWorker`, `SingleAcquisitionWorker`, `DarkFrameWorker`), connects signals, and handles overall window lifecycle events.
- **`ControlPanel`**
